...
import imagenhome1 from '../../images/imagen-page-inicio/Imagen-inicio.png'

function Home() {
  return (
    <div className="di">
      <div className="lg:pt-14 lg:pb-10 lg:justify-center items-center text-center bg-cover bg-center p-4 sm:p-5 lg:p-5" style={{ backgroundImage: `url(${imagenhome1})` }}>
