...
function Contacto() {
  return (
    ...
    <div className="lg:pt-14 lg:pb-10 lg:justify-center items-center text-center bg-cover bg-center p-4 sm:p-5 lg:p-5" style={{ backgroundImage: `url(${contactenoimagen})` }}>
    ...
    <div className="bg-[#412a56] p-4 sm:p-10 lg:p-20">
      <div className="bg-[#faf9fb] p-4 sm:p-5 lg:p-5 flex flex-col sm:flex-row items-center justify-between">
        ...
        <img className="mx-auto w-[200px] sm:w-[250px] lg:w-[300px]" alt="Happy bunch chat" src={imagencontacto} />
